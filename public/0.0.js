...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}],\"react\"],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}]]}!./resources/assets/js/views/auth/Register.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_MessageDialog__ = __webpack_require__("./resources/assets/js/components/MessageDialog.js");
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        touched.password_confirmation && errors.password_confirmation && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'p',
                            { className: 'mdc-text-field-helper-text  mdc-text-field-helper-text--validation-msg  form-error',
                                'aria-hidden': 'true',
                                'aria-live': 'polite' },
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'button',
                    {
                        className: 'mdc-button mdc-card__action  mdc-button--dense mdc-theme--primary-bg  mdc-theme--primary-light' },
                    'Create'
                )
            )
        )
...
var FormikForm = Object(__WEBPACK_IMPORTED_MODULE_4_formik__["b" /* withFormik */])({
    ...
    validationSchema: __WEBPACK_IMPORTED_MODULE_5_yup___default.a.object().shape({
        ...
        username: __WEBPACK_IMPORTED_MODULE_5_yup___default.a.string().required('This field is required.').matches(/^[a-zA-Z]+[a-zA-Z0-9._]*$/, 'Must only contain letters, numbers, period(.) and underscore(_).').max(150, 'Must not exceed 150 characters.'),
        email: __WEBPACK_IMPORTED_MODULE_5_yup___default.a.string().email('This email is invalid.').required('This field is required.'),
        password: __WEBPACK_IMPORTED_MODULE_5_yup___default.a.string().required('This field is required.').min(8, '').max(150, ''),
        password_confirmation: __WEBPACK_IMPORTED_MODULE_5_yup___default.a.string().required('This field is required.').oneOf([__WEBPACK_IMPORTED_MODULE_5_yup___default.a.ref('password'), null], 'Passwords don\'t match.').min(8, '').max(150, '')
    ...
    handleSubmit: function handleSubmit(values, _ref) {
        ...
        axios.post('/api/users/register', values).then(function (resp) {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["f" /* withRouter */])(Register));
